...
class macroActivity(customtkinter.CTk):
    def __init__(self):
        ...
        version_label = customtkinter.CTkLabel(tabview.tab("Home"), text="BETA BUILD (V0.11)", font=customtkinter.CTkFont(family="Segoe UI", size=14, weight="bold"))
    ...
    def stop(self):
        ...
        self.config.set('Stats', 'total_biomes_discovered', self.totalBiomesFound)
        with open(self.config_name, 'w+') as configfile:
            self.config.write(configfile)
    ...
    def send_ingame_screenshot(self):
        try:
            ...
            embed = {
                ...
                "color": 0xffffff,
                "footer": {"text": "Til's Macro (v0.11)", "icon_url": icon_url},
